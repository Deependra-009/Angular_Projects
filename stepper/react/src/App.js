    ...
    <>
      <div class="w-[100%] p-10 flex justify-center">
        <div class="w-[80%]">
          {/* heading */}
          <div
            class="w-[100%] text-[25px] text-red-500 font-semibold flex justify-center items-center"
          >
            {/* Stepper */}
          </div>
          <div class="w-[100%] py-10">
            ...
            {(step == 1) && <div class="w-[100%] py-10 text-[20px]">Step 1 (Personal Info)</div>}
            {(step == 2) && <div class="w-[100%] py-10 text-[20px]">Step 2 (Account Info)</div>}
            {(step == 3) && <div class="w-[100%] py-10 text-[20px]">Step 3 (Confirmation)</div>}
            {(step == 4) && <div class="w-[100%] py-10 text-[20px]">Step 4 (Done)</div>}
            ...
            <div class="w-[100%] mt-10 flex justify-between">
              {/* back button */}
